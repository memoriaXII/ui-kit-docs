...
`0.2.1` — API is stabilizing. Internal apps are being white-labeled onto the kit before external partners onboard.

```bash
pnpm add @appboxo/ui-kit
```

Published on npm as [`@appboxo/ui-kit`](https://www.npmjs.com/package/@appboxo/ui-kit). See [Setup](/docs/setup) for the full peer-dependency list and host wiring.
